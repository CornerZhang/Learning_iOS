...
@interface ParamTableViewController () {
    NSArray* keys;
}

@end

@implementation ParamTableViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NSString* keyName = [keys objectAtIndex:indexPath.row];
    NSString* valueString;
    id valueObject = [self.param objectForKey:keyName];
    if ([valueObject isKindOfClass:[NSNumber class]]) {
        valueString = [NSString stringWithFormat:@"%d", [(NSNumber*)valueObject integerValue]];
